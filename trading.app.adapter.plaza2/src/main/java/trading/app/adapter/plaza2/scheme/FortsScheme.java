...
public final class FortsScheme
{
...
// ------------------------------------------
	...
	public static final int MSG_SIZE = 234;
        private java.nio.ByteBuffer data;
    ...
    public static final class multileg_deal
    {
        public static final int TABLE_INDEX = 3;
        
	public static final int MSG_SIZE = 215;
        private java.nio.ByteBuffer data;
        ...
        public multileg_deal(java.nio.ByteBuffer data) {
            this.data = data;
        }
        ...
        public java.math.BigDecimal get_buyback_amount() {
            data.position(205);
            return ru.micexrts.cgate.P2TypeParser.parseBCDAsBigDecimal(data);
        }

        public void set_buyback_amount(java.math.BigDecimal val) {
            data.position(205);
            ru.micexrts.cgate.P2TypeComposer.composeBigDecimalAsBCD(data, "d16.2", val);
        }

        
        public byte get_buyback_amount_scale() {
            data.position(205);
            return ru.micexrts.cgate.P2TypeParser.parseBCDAsScale(data);
        }
